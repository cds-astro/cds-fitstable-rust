...
2 - For a relatively small FITS files,
download [this bash script](https://raw.githubusercontent.com/cds-astro/cds-fitstable-rust/refs/heads/main/crates/cli/resources/hipsgen.bash)
and run it with 4 arguments:
