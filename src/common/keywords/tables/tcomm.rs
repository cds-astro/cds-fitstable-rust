//! Defines the `TCOMMn` (i.e. column description) keyword for `ASCIITABLE` and `BINTABLE` extensions.
use crate::{
  common::{
...
impl TComm {
  /// # Params
  /// * `n` the `TCOMMn` number in `[1, TFIELD]`.
  /// * `value` value associated to this `TCOMMn` keyword, i.e. the description of the column number `n`
...
impl DynValueKwr for TComm {
  const KW_PREFIX: &'static [u8] = b"TCOMM";
  ...
  {
    let comment = format!("Description of column #{}", self.n);
